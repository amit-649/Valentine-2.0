                    ...
                    {contractStage === 'initial' ? (
                        <>
                            ...
                            <div className="flex justify-center gap-4 mb-8">
                                ...
                                <img src="https://media.tenor.com/5mY0_O3V9PIAAAAi/peach-goma-peach-and-goma.gif" alt="Cute bears 2" className="w-32 h-32 rounded-xl shadow-md object-cover" />
                            </div>
                        ...
                        >
                            ...
                            <div className="bg-red-50 border-2 border-red-100 rounded-xl p-6 text-left space-y-3 mb-6">
                                ...
                                <p className="flex items-center gap-2 text-green-700 font-bold">
                                    <Check size={20} className="text-green-500" /> You're stuck with your gandu boyfriend FOREVER 😈
                                </p>
                            </div>
                            <button 
                                onClick={() => {
        ...
        >
            ...
            <Section id="dates" className="bg-white/50 backdrop-blur-sm">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500">Since we can't be together right now...</p>
                </div>
                <DateIdeas />
            </Section>
            ...
            <Section id="reasons" className="bg-romantic-50">
             ...
             <Section id="surprises" className="bg-white/50 backdrop-blur-sm pb-32">
                <div className="text-center mb-10">
                    ...
                    <Surprises />
                    <p className="mt-8 text-gray-500 text-sm">Click each button for a surprise message 😉</p>
                </div>
            </Section>

            <footer className="w-full py-8 text-center text-romantic-300 text-sm font-light bg-white/30">
                Made with <Heart size={12} className="inline text-red-400 fill-red-400" /> + too much horniness by your gandu boyfriend
            </footer>
        </motion.div>
      )}
    </div>
